...
5. O pigmento dos bastonetes tem um pico de absorção em, mais ou menos, $510nm$. O pigmento dos cones tem picos de absorção em: $430nm$, $530nm$ e $560nm$. Os pigmentos absorvidos de fato nesses comprimentos aparecem mais como **<span style="color:violet">violeta</span>**, **<span style="color:#4bcae3">azul-esverdeado</span>** e **<span style="color:#d4e34b">amarelo-esverdeado</span>**. 
...
![alt text](imagens/receptors_response.png)
...
7. A existência de três cones, e não apenas um, é a seguinte:
    ...
    ![alt text](imagens/two-cones.png)
...
11. Por mais que o pico do cone vermelho seja em $560nm$, de tom mais **<span style="color:#d4e34b">amarelo-esverdeado</span>**, a excitação em tons mais próximos da cor vermelha real é o que estimula mais os cones vermelhos com relação aos verdes, por isso talvez eles são entendidos como "cones vermelhos".
![](imagens/receptors_response_diff.png)
...
![alt text](imagens/perceptions.png)
